...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="tipo_de_prenda" placeholder="Tipo de Prenda" value="<?php echo "$tipo_prenda"; ?>"> //dentro del value ponemos el dato que que trajimos del egistro para que ya aparezca el el imput y no volver aq escribirlo<br><br>
            <label>Marca</label><br>
            <input type="text" name="marca" placeholder="Marca" value="<?php echo "$marca"; ?>"><br><br>
            <label>Talle</label><br>
            <input type="text" name="talle" placeholder="Talle" value="<?php echo "$talle"; ?>"><br><br>
            <label>Precio</label><br>
            <input type="text" name="precio" placeholder="Precio" value="<?php echo "$precio"; ?>"><br><br>
            <label>Imagen</label><br>
            <input type="file" name="imagen" placeholder="imagen"><br><br>
            <input type="submit" name="guardar_cambios" value="Guardar Cambios"><br><br>
