...
<h1>Trabajo Practico Nº2  -  Dominguez Julian</h1>
    ...
    if($numero1 > $numero2) {
        echo "La suma de las variables numero1 y numero2 es: ", $suma ,"\t\t";
        echo "La resta de las variables numero1 y numero2 es: ", $resta;
    }
    elseif($numero2 > $numero1){
        echo "La multiplicacion de las variables numero1 y numero2 es: ", $multiplicacion ,"\t\t";
        echo "La division entera de las variables numero1 y numero 2 es: ", $division_entera,"\t\t";
        echo "El resto de la division de las variables numero1 y numero2 es: ", $resto_division;
    }
    else {
